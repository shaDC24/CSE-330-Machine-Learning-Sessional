...
for epoch in range(5):
    ...
    for images, labels in train_loader:
        ...
        t += 1
        adam_update(params, grads, states, t)      # 🔥 change here
        # adagrad_update(params, grads, states)
        # rmsprop_update(params, grads, states)
...
for epoch in range(5):
    ...
    for images, labels in train_loader:
        ...
        t += 1
        adam_update(params, grads, states, t)   # 🔥 switch optimizer here
        # adagrad_update(params, grads, states)
        # rmsprop_update(params, grads, states)
        running_loss += loss.item() * images.size(0)
        _, predicted = outputs.max(1)
